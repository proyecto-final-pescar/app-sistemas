          ...
          <div style={{ display: "flex", minHeight: "100vh", backgroundColor: "#f8f7ff" }}>
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
              ...
              <main style={{ padding: "24px", flex: 1, fontFamily: "Arial, Helvetica, sans-serif" }}>
                <h1 style={{ margin: 0, color: "#24113f", fontSize: "28px", fontWeight: "800" }}>{activePage}</h1>
                <p style={{ color: "#7c6aa6", fontSize: "16px", marginTop: "12px" }}>Contenido de prueba — página: {activePage}</p>
              </main>
            </div>
          </div>
        } />
